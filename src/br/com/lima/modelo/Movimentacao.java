 ...
 */
@Entity
@NamedQuery(query="select avg(m.valor) from Movimentacao m where m.conta = :pConta"//definindo uma namedQuery que � uma query padr�o definida diretamente na entidade
		+" and m.tipo = :pTipo "
